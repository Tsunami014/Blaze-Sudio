...
class Point(Shape):
    ...
    def handleCollisionsPos(self, oldPoint: Point | pointLike, newPoint: Point | pointLike, objs: Shapes | Iterable[Shape], accel: pointLike = [0, 0], replaceSelf: bool = True, precision: Number = ..., verbose: bool = False) -> tuple['Point', pointLike, verboseOutput]: ...
    def handleCollisionsAccel(self, accel: pointLike, objs: Shapes | Iterable[Shape], replaceSelf: bool = True, precision: Number = ..., verbose: bool = False) -> tuple['Point', pointLike, verboseOutput]: ...
    def copy(self) -> Point: ...
