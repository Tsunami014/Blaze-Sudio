...
class Character:
    ...
    async def __call__(self, who, prt=False):
        """
    ...
    def stop_generating(self):
        self.AI.stop_generating()
    
    def any_more(self):
        ret = ''
        if self.AI.resp != self.seen:
            ret = self.AI.resp[len(self.seen):]
            self.seen = self.AI.resp
        return ret
